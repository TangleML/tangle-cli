...
T = TypeVar("T", bound="GetExecutionInfoResponseOutputArtifactsType0")


@_attrs_define
class GetExecutionInfoResponseOutputArtifactsType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        get_execution_info_response_output_artifacts_type_0 = cls()
        ...
        get_execution_info_response_output_artifacts_type_0.additional_properties = additional_properties
        return get_execution_info_response_output_artifacts_type_0
