...
T = TypeVar("T", bound="TaskSpecArgumentsType0")


@_attrs_define
class TaskSpecArgumentsType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        task_spec_arguments_type_0 = cls()
        ...
        task_spec_arguments_type_0.additional_properties = additional_properties
        return task_spec_arguments_type_0
